...
>
	<span class="github-top">
		<svg class="github-icon" viewBox="0 0 512 512" aria-hidden="true">
			<path
				fill="currentColor"
...
<style>
	.github-badge {
		...
		background: var(--nav-pill-bg, rgba(255, 255, 255, 0.14));
		border: 1px solid var(--nav-pill-border, rgba(255, 255, 255, 0.16));
